...
class ExecutiveDashboardService
{
    public function summary(): array
    {
        return [
            ...
            'pending_leave'=>LeaveRequest::whereIn('status',['submitted','supervisor_approved'])->count(),
            'active_assets'=>Asset::whereNotIn('status',['retired','disposed','lost'])->count(),
            'open_purchase_requests'=>PurchaseRequest::whereNotIn('status',['closed','cancelled','rejected'])->count(),
        ];
    }
}
